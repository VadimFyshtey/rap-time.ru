            ...
            <table class="table table-hover">
                ...
                @foreach($users as $user)
                    <tr>
                        ...
                        <td>{{ $user->name }}</td>
                        <td>{{ $user->email }}</td>
                        <td><img class="admin-list-image" src="{{ asset($user->avatar) }}" alt="{{ $user->name }}" title="{{ $user->name }}" /></td>
